                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(
                              left: 20.0, right: 15.0, top: 18, bottom: 10),
                          child: Row(
                            children: [
                              Icon(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(
                              left: 15.0, right: 15.0, top: 18, bottom: 10),
                          child: Icon(
                            Icons.tune,
                            size: 24,
                            color: Theme.of(context).colorScheme.primary,
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(
                                left: 15.0, right: 20.0, top: 18, bottom: 10),
                            child: Icon(
                              isGrid
                                  ? Icons.grid_view
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: UnderlineInputBorder(
            borderSide: BorderSide(
                color: Theme.of(context).colorScheme.onSecondary.withOpacity(0.6), width: 1),
          ),
...
class HomeListviewWidget extends StatelessWidget {
  const HomeListviewWidget({Key? key,this.image, this.itemName, this.description, this.id, this.price, this.discount, this.images, this.onTap}) : super(key: key);
